...
(async () => {
  ...
  try {
    ...
    await expect(page.locator('.demo-ribbon')).toContainText('DEMO MODE');
    await expect(page.locator('.demo-ribbon')).toContainText('Simulated scope. No USB device commands are sent.'); checks++;
